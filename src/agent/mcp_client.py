...
Return the tool output as-is."""
    ...
    async def all_txs(self, address: str, blockchain_name: str, filter_criteria: dict | None = None, limit: int = 100, offset: int = 0, direction: str = "asc", order: str = "time", transaction_type: str = "all") -> dict[str, Any]:
